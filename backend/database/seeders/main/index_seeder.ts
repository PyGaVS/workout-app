...
export default class IndexSeeder extends BaseSeeder {
  ...
  async run() {
    await this.seed(await import('#database/seeders/muscle_seeder'))
    await this.seed(await import('#database/seeders/exercise_seeder'))
    await this.seed(await import('#database/seeders/user_seeder'))
    await this.seed(await import('#database/seeders/workout_seeder'))
    await this.seed(await import('#database/seeders/exercise_bloc_seeder'))
    await this.seed(await import('#database/seeders/set_seeder'))
  }
}
